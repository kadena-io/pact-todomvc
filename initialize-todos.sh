...
./load-pact.js -cf pact/todos.pact -n hello -s $secKey -p $pubKey -d '{"todo-admin-keyset":{"keys":["06c9c56daa8a068e1f19f5578cdf1797b047252e1ef0eb4a1809aa3c2226f61e"],"pred":"="}}' | curl -X POST -d @- http://localhost:$1/api/v1/send
